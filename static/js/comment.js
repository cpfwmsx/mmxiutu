...
var _renderHTML = function _renderHTML(params) {
    ...
    var footer = "<div class=\"discussion-item discussion-item-labeled\"><h3 class=\"discussion-item-header f5 text-normal\" id=\"event-1157063333\"><span class=\"discussion-item-icon\"><svg aria-hidden=\"true\" class=\"octicon octicon-tag\" height=\"16\" version=\"1.1\" viewBox=\"0 0 16 16\" width=\"14\"><path fill-rule=\"evenodd\" d=\"M15 1H6c-.55 0-1 .45-1 1v2H1c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h1v3l3-3h4c.55 0 1-.45 1-1V9h1l3 3V9h1c.55 0 1-.45 1-1V2c0-.55-.45-1-1-1zM9 11H4.5L3 12.5V11H1V5h4v3c0 .55.45 1 1 1h3v2zm6-3h-2v1.5L11.5 8H6V2h9v6z\"></path></svg></span>Powered By " + site + ".</h3></div>";
    if ((!issue || !issue.body || issue.body == "") && (!comments || comments.length <= 0)) {
        var _res = "<div class='js-discussion no-comment'><span>" + no_comment + "</span></div>";
        $(comments_target).append(_res);
    } else {
        var _res2 = "<div class=\"discussion-timeline js-quote-selection-container\"><div class=\"js-discussion js-socket-channel\">";
    ...
    var res = "<p class=\"goto-comment\"><a href=\"" + issue_url + "\" class=\"" + btn_class + "\" target=\"_blank\">" + go_to_comment + "</a></p>";
